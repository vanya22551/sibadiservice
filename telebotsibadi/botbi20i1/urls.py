...
from .views import update_changes,lab_add_view, LoginUserView, RegisterUserView, LogoutView, userPage, ChangePasswordView, \
    FileAddView, view_info
urlpatterns = [
    path('', facePage.as_view(), name='face_page'),
    path('face_page', facePage.as_view(), name='face_page'),
    ...
    path(r'user', userPage.as_view(), name='user_page'),
